...
class PrivateTagsApiTests(TestCase):
    ...
    def test_filter_tags_by_assigned_recipes(self):
        """Test filtering tags by assigned recipes"""
        tag1 = Tag.objects.create(user=self.user, name="Breakfast")
        tag2 = Tag.objects.create(user=self.user, name="Lunch")
        recipe = Recipe.objects.create(
            user=self.user, title="Eggs on toast", time_minutes=10, price=5.00
        )
    ...
    def test_filter_tags_by_assigned_recipes_unique(self):
        """Test filtering tags by assigned recipes are unique"""
