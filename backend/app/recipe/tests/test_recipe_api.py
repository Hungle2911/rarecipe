...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        original_recipe = "https://www.sample.com/recipe.pdf"
        recipe = create_recipe(
            user=self.user,
            title="Chicken tikka",
            link=original_recipe,
        )
        ...
        self.assertEqual(recipe.link, original_recipe)
        self.assertEqual(recipe.user, self.user)
    ...
    def test_full_update_recipe(self):
        ...
        payload = {
            ...
            "link": "https://www.sample.com/spaghetti.pdf",
            "description": "Sample description",
            "time_minutes": 25,
            "price": Decimal("7.00"),
        }
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Egg curry")
        r2 = create_recipe(user=self.user, title="Egg fried rice")
        ...
        r3 = create_recipe(user=self.user, title="Chicken curry")
